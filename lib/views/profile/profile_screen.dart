          ...
          child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (widget.isOtherUser!) {
                  ...
                  try {
                    profileImage = userSnapshot.get('image');
                  } catch (e) {
                    profileImage = '';
                  ...
                  try {
                    locationController.text = userSnapshot.get('location');
                  } catch (e) {
                  ...
                  try {
                    followers = userSnapshot.get('followers').length;
                  } catch (e) {
                    followers = 0;
                  ...
                  try {
                    following = userSnapshot.get('following').length;
                  } catch (e) {
                    following = 0;
                  ...
                  try {
                    userFollowerList = userSnapshot.get('followers');
                  } catch (e) {
                    userFollowerList = [];
                  }

                  try {
                    myFollowingList = userSnapshot.get('following');
                  } catch (e) {
                    myFollowingList = [];
                  }
                } else {
                  try {
                    nameController.text =
                        dataController!.userDocumentSnapshot!.get('name');
                  } catch (e) {
                    nameController.text = '';
                    debugPrint('NameError: $e');
                  }
                  ...
                  try {
                    profileImage =
                        dataController!.userDocumentSnapshot!.get('image');
                  } catch (e) {
                    profileImage = '';
                    debugPrint('ProfileImageError: $e');
                  }
                  ...
                  try {
                    descriptionController.text = dataController!
                  ...
                  try {
                    followers = dataController!.userDocumentSnapshot!
                        .get('followers')
                        .length;
                  } catch (e) {
                    followers = 0;
                  ...
                  try {
                    following = dataController!.userDocumentSnapshot!
                        .get('following')
                        .length;
                  } catch (e) {
                    following = 0;
                  ...
                  children: [
                    ...
                    widget.isOtherUser!
                        ...
                        : Align(
                            ...
                            child: Container(
                              margin:
                                  const EdgeInsets.only(top: 105, right: 35),
                              child: InkWell(
                                onTap: () {
                                  if (!isNotEditAble &&
